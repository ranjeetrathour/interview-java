...
/**
 * reduce function is used to do same task
 */
public class OverallSalaryGroupByDepartment {
    public static void main(String[] args) {
        ...
        Map<String, Double> collect = employees.stream().collect(Collectors.groupingBy(Employee::getDept, Collectors.reducing(
                0d,
                Employee::getSalary,
                Double::sum
        )));
