...
public class PrintSpecificAttributeUsingStream {
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Rahul Tiwari", "IT", 40000, LocalDateTime.now().minusDays(18)));
        ...
        employees.stream().filter(employee -> employee.getDept().equalsIgnoreCase("it") && employee.getSalary()>50000)
                .forEach(e->{
